...
### Rakenne
Kansiot 0.1, 0.2, 0.3 ja 0.4 sisältävät verkkoja eri estetiheyksillä. plot_images sisältää "maastokartat" jotka on muutettu verkoiksi. raw_test data sisältää .csv tiedostoja kokeen tuloksista. test_md_files sisältää testitiedostoja, jotka on puitu luettavaan muotoon.
## Kokeen rakenne
## Alkuperäiskartta
